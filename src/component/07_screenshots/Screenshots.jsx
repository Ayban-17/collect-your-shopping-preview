    ...
    <section className="bg-grey flex flex-col items-center">
        <div className="max-w-[1440px] px-8">
            ...
            <div className=" relative lg:py-16 lg:flex lg:items-center lg:justify-center lg:gap-4">
                ...
                <button className="w-8 h-8 border-2 border-green text-green rounded-full p-1  hidden lg:inline-block lg:mx-8" onClick={handlePrev}><ChevronLeftIcon/></button>
                <div className="-translate-x-[387px] flex items-center gap-8 lg:translate-x-[1px]  lg:gap-5">
                ...
                <button className="w-8 h-8 border-2  border-green text-green rounded-full p-1  hidden lg:inline-block lg:mx-8" onClick={handleNext}><ChevronRightIcon/></button>
            </div>

            <div className="flex flex-col gap-2 py-8" >
                <h1 className="text-center text-green font-semibold text-lg">{focus[3].title}</h1>
                <p className="text-center px-2 text-base font-light lg:px-[350px] lg:text-sm">{focus[3].desc}</p>
