...
const Testimonials = ({clientTestimonialsTitle, clientTestimonialsDesc, clientTestimonial}) => {
  ...
  return (
    <section className="relative overflow-hidden flex flex-col items-center md:h-screen lg:h-full">
        ...
        <div className="max-w-[1440px] px-10 mt-16 lg:flex lg:flex-col lg:items-center md:mt-0 md:mb-10 lg:my-20 lg:gap-10 lg:mb-10">
                        ...
                        testimonials.map(({imgMob, imgWeb, name, address},index)=>(
                            <article className={`rounded-xl overflow-hidden relative z-10 bg-white shadow-2xl lg:grid lg:grid-cols-2 lg:h-[560px] lg:w-[1085px] ${style.testimonial} `} key={index}>
                                ...
                                <div className="p-6 flex flex-col gap-6 lg:px-[125px] lg:py-16 lg:gap-16">
                                    ...
                                    <p className="text-base font-light">{clientTestimonial}</p>
