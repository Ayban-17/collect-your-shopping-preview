    ...
    <section className="flex flex-col items-center">
        ...
        <div className="max-w-[1440px] px-8 py-10 lg:grid lg:grid-cols-2 lg:grid-rows-2 lg:pt-52 lg:pb-32 lg:gap-x-[95px]">
            ...
            <div className=" rounded-2xl mb-8 overflow-hidden lg:rounded-3xl lg:col-start-1 lg:row-span-2 lg:row-start-1 lg:w-[500px] lg:h-[500px]">
                ...
                <Image src="/assets/10_faqs/faqsWeb.jpg" height={600} width={600} alt="faq" className="hidden rounded-2xl mb-8 lg:h-[500px] lg:w-[500px] lg:block lg:col-start-1 lg:row-span-2 lg:row-start-1 lg:object-cover"/>
            </div>

            <div className="lg:flex lg:flex-col lg:gap-2 lg:-mt-[73px] lg:-ml-5">
